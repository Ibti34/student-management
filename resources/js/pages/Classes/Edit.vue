...
const form = useForm({
  ...
  homeroom_teacher: props.schoolClass.homeroom_teacher ?? '',
  capacity: props.schoolClass.capacity ?? '',
})
  ...
  <AppLayout>
    <div class="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div class="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Edit Cohort</h1>

        <form @submit.prevent="submit" class="space-y-4">
          <div>
            <label class="block text-sm font-semibold text-gray-600 mb-1">Program</label>
            <input v-model="form.name" type="text" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none" />
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="form.section" type="text" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none" />
            ...
            <div>
              ...
              <input v-model="form.academic_year" type="text" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none" />
          ...
          <div>
            ...
            <input v-model="form.homeroom_teacher" type="text" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none" />
          ...
          <div>
            ...
            <input v-model="form.capacity" type="number" class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none" />
          ...
          <button type="submit" :disabled="form.processing" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition duration-300 disabled:bg-blue-300">
            {{ form.processing ? 'Updating...' : 'Update Cohort' }}
          </button>
        </form>
      </div>
    </div>
