        ...
        <div class="min-h-screen bg-[#f8fafc] px-4 py-12 text-slate-900 font-sans">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <Link :href="user.role === 'student' ? route('marks.my') : route('marks.index')" class="nav-card p-8 bg-white rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
